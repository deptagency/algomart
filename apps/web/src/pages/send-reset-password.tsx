...
import SendResetPasswordTemplate from '@/templates/send-reset-password-template'
import { validateSendPasswordReset } from '@/utils/auth-validation'
...
export default function ResetPasswordPage() {
  ...
  const validate = useMemo(() => validateSendPasswordReset(t), [t])

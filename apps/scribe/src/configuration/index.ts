...
export const Configuration = {
  ...
  get merchantWalletBalance() {
    const notificationEmail = env
      .get('MERCHANT_WALLET_BALANCE_NOTIFICATION_EMAIL')
      .default('')
      .asString()
    const usdThreshold = env
      .get('MERCHANT_WALLET_BALANCE_USD_THRESHOLD')
      .default('1000.00')
      .asString()
    return {
      notificationEmail,
  ...
  get onfidoAdapterOptions(): OnfidoAdapterOptions {
    return {

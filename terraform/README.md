...
| `pinata_api_key`                  | The API key from https://pinata.cloud that allows files and metadata to be stored on IFPS                                   |
| `pinata_api_secret`               | The API secret from https://pinata.cloud that allows files and metadata to be stored on IFPS                                |
